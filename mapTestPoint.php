  ...
  <head>
    ...
    <script>
      ...
      <?php
        ...
        $reqPays = $connexion->prepare("SELECT pays.NOM FROM pays WHERE LENGTH(pays.NOM) > 0; ");
        $reqPays->execute();
        ...
        $T = "SELECT tsocietes.NOM, tsocietes.longitude, tsocietes.latitude, tsocietes.CAT_SOCIETE, 
                pays.NOM as pays, tsocietes.TEL, tsocietes.ID_SOCIETE,
                tsocietes.SITE_INTERNET,
                tsalaries.NOM as NomResp, tsalaries.PRENOM as PrenomResp
                FROM tsocietes, pays, tsalaries 
                where tsocietes.country = pays.ID 
                  and tsocietes.ID_RESPONSABLE_ALSIM = tsalaries.ID_PERSONNE
                  and tsocietes.CAT_SOCIETE is not null
                  and LENGTH(pays.NOM) > 0 and pays.NOM is not null
      ...
      tabDepart.forEach(lline =>{
        ...
        // {
        //   $req = $connexion->prepare("SELECT tsocietes.NOM, taddresses.longitude, taddresses.latitude 
        //                               FROM tsocietes, taddresses, pays 
        //                               where tsocietes.ID_SOCIETE = taddresses.society and taddresses.country = pays.ID and pays.NOM = '$pays' and taddresses.longitude is not null 
        //                               and taddresses.latitude is not null; ");
        //   $req->execute();
        // }
        // else
        ...
        //         FROM tsocietes, taddresses, pays 
        //         where tsocietes.CAT_SOCIETE = '$categorie' and tsocietes.ID_SOCIETE = taddresses.society and taddresses.country = pays.ID and pays.NOM = '$pays' and taddresses.longitude is not null 
        //                               and taddresses.latitude is not null;";
